...
public:
    ...
    {
        keyboardComponent = new CustomMidiKeyboardComponent(keyboardState, MidiKeyboardComponent::horizontalKeyboard);
...
private:
	...
	ScopedPointer<MidiKeyboardComponent> keyboardComponent;     // MIDIKeyboadComponentクラスのポインタ
